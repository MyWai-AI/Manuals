---
title: "Installation on Raspberry Pi 4"
---
...
```bash
    sudo docker load --input edge.tar
    sudo docker create -p 1883:1883 -p 9001:9001 -p 8023:8023 -v /home/pi/EdgeIO:/EdgeIO --name edgecontainer --net mywai --ip 192.168.5.3 edge:latest -e IotHubAzure__ConnectionString=XXX -e IotHubAzure__EdgeID=MyEdge
```
